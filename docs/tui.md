# ccproxy TUI Documentation

## Overview

The ccproxy Terminal User Interface (TUI) provides an interactive way to manage your Claude API load balancer. Built with React and Ink, it offers real-time monitoring, account management, and comprehensive analytics all from your terminal.
...
- ccproxy project dependencies installed
...
- **Dependency Injection**: Uses @ccproxy/core-di for service management
